...
app.get('/', (req, res) => {
    res.status(200).json({ message: "Rodando na porta 3000" });
});
...
app.post('/auth/register', async (req, res) => {
    ...
    if (userExists)
        return res.status(400).json({ msg: 'Usuário já existe. Por favor utilize outro email.' })
...
mongoose.connect(
    `mongodb+srv://${dbUser}:${dbPassword}@cluster0.xboh4.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`
).then(
    app.listen(3000, () => {
